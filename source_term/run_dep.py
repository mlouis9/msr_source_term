...
bluecrab_run_command = f"ml use.moose {params['moose_dev_env']}; mpiexec -n {num_procs} moose-dev-exec \"{params['blue_crab_executable']} -i run_dep.i --n-threads={num_cores}\""
